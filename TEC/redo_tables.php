...
function Create_All_Tables()
{
    ...
    ALTER TABLE JOB_HISTORY ADD CONSTRAINT FOREIGN KEY (CANDIDATE_ID) REFERENCES CANDIDATE(CANDIDATE_ID);
   	ALTER TABLE QUALIFICATION ADD CONSTRAINT FOREIGN KEY (CANDIDATE_ID) REFERENCES CANDIDATE(CANDIDATE_ID);
    ALTER TABLE PAYING ADD CONSTRAINT FOREIGN KEY (CANDIDATE_ID) REFERENCES CANDIDATE(CANDIDATE_ID);
    
    ALTER TABLE COURSE_PREREQ ADD CONSTRAINT FOREIGN KEY (COURSE_ID) REFERENCES COURSE(COURSE_ID);
    ALTER TABLE SESSION ADD CONSTRAINT FOREIGN KEY (COURSE_ID) REFERENCES COURSE(COURSE_ID);
    
    ALTER TABLE PLACEMENT ADD CONSTRAINT FOREIGN KEY (OPENING_ID) REFERENCES OPENING(OPENING_ID);
    
    ALTER TABLE OPENING ADD CONSTRAINT FOREIGN KEY (COMPANY_ID) REFERENCES COMPANY(COMPANY_ID);
        
    ALTER TABLE COURSE_PREREQ ADD CONSTRAINT FOREIGN KEY (QUALIFICATION_CODE) REFERENCES QUALIFICATION(QUALIFICATION_CODE);
    
    ALTER TABLE QUALIFICATION ADD CONSTRAINT FOREIGN KEY (QUALIFICATION_CODE) REFERENCES DEGREE(QUALIFICATION_CODE);
    
    ALTER TABLE PAYING ADD CONSTRAINT FOREIGN KEY (SESSION_ID) REFERENCES SESSION(SESSION_ID);
