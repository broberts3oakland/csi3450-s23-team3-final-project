...
function Create_All_Tables($conn)
{
  ...
  TODO Left off at "ALTER TABLE COURSE ADD CONSTRAINT FOREIGN KEY (QUALIFICATION_CODE) REFERENCES QUALIFICATION(QUALIFICATION_CODE);
  ...
  $sql = "CREATE TABLE IF NOT EXISTS CANDIDATE(
      ...
      JOB_HISTORY INT,
      COURSE_TAKING INT,
      QUALIFICATION_CODE VARCHAR(50) UNIQUE,
